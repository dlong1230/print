    ...
    [
        function (t, e, n) {
            ...
            n.d(e, "a", function () {
                ...
                var n = Math.floor(t.length / 2), i = t.splice(n, 1)[0], o = [], r = [];
                ...
                function t() {
                    this.providers = [], this.movingDistance = 1.5, this.paperHeightTrim = 1, this.text = {
                        ...
                        supportOptions: [{
                            ...
                            borderWidth: .75, height: 9, width: 90
                        }
                    }, this.vline = {
                        supportOptions: [{
                            name: "borderColor", hidden: !1
                            ...
                            borderWidth: void 0, height: 90, width: 9
                        }
                    }, this.rect = {
                        supportOptions: [{
                            name: "borderColor", hidden: !1
                            ...
                            borderWidth: void 0, height: 90, width: 90
                        }
                    }, this.oval = {
                        supportOptions: [{
                            name: "borderColor", hidden: !1
            ...
            var o = function () {
                ...
                return Object.defineProperty(t, "instance", {
                    ...
                    if (-1 == $(t).attr("src").indexOf("base64")) try {
                        var e = document.createElement("canvas"), n = new Image();
        ...
        function (module, __webpack_exports__, __webpack_require__) {
            ...
            var _entity_PrintElementEntity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17),
                ...
                _HiPrintlib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2), BasePrintElement = function () {
                    ...
                    return BasePrintElement.prototype.getConfigOptionsByName = function (t) {
                        ...
                        var e = this.getData(), n = this.createTarget(this.getTitle(), e);
                        ...
                        var n = this.options.showInPage, i = this.options.unShowInPage;
                        ...
                        this.designTarget.hidraggable({
                            ...
                            showPoints: n.getReizeableShowPoints(), onBeforeResize: function onBeforeResize() {
                        ...
                        var o = [], r = this.getBeginPrintTopInPaperByReferenceElement(t), a = t.getPaperFooter(i);
                        this.isHeaderOrFooter() || this.isFixed() || r > a && (o.push(new _dto_PaperHtmlResult__WEBPACK_IMPORTED_MODULE_3__.a({
                            target: void 0, printLine: void 0
                        ...
                        return this.updateTargetSize(s), this.css(s, p), s.css("position", "absolute"), s.css("left", this.options.displayLeft()), s.css("top", r + "pt"), o.push(new _dto_PaperHtmlResult__WEBPACK_IMPORTED_MODULE_3__.a({
                            target: s, printLine: r + this.options.getHeight()
                        })), o;
                        ...
                        var n = this, i = [], o = this.getConfigOptions();
                        ...
                        var e = [], n = this.getConfigOptionsByName(t);
                        ...
                        var e = $(".toplineOfPosition" + this.id), n = $(".leftlineOfPosition" + this.id),
                            i = $(".rightlineOfPosition" + this.id), o = $(".bottomlineOfPosition" + this.id);
                        ...
                        var e = this.designTarget.offset().left, n = this.designTarget.offset().top;
        ...
        function (t, e, n) {
            ...
            var i = function () {
            ...
            }(), a = n(10), p = n(14), s = n(11), l = function () {
                function t() {
                }
                ...
                return t.prototype.init = function (t, e, n, i) {
                    ...
                    var e = t.rect, n = this.getTableRect();
        ...
        function (module, __webpack_exports__, __webpack_require__) {
            ...
            var _ReconsitutionTableColumns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19),
                _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0), TableExcelHelper = function () {
                    ...
                    return TableExcelHelper.createTableHead = function (t, e) {
                        ...
                        var o = TableExcelHelper.reconsitutionTableColumnTree(t), r = $("<tbody></tbody>");
                        ...
                        o.data("rowData", e), t.rowColumns.forEach(function (t, i) {
                            ...
                            var a = TableExcelHelper.getColumnFormatter(t), p = a ? a(e[t.field], e, i, n) : e[t.field];
                            r.html(p);
                        ...
                        var e = TableExcelHelper.reconsitutionTableColumnTree(t), n = $("<tr></tr>");
                        ...
                        var n = {}, i = TableExcelHelper.allAutoWidth(t), o = TableExcelHelper.allFixedWidth(t);
                        return t.rowColumns.forEach(function (t) {
                            if (t.fixed) n[t.id] = t.width; else {
                                var r = e - o, a = t.width / i * (r > 0 ? r : 0);
                                n[t.id] = a;
                            }
                        }), n;
                    }, TableExcelHelper.resizeTableCellWidth = function (t, e, n) {
                        var i = TableExcelHelper.reconsitutionTableColumnTree(e), o = TableExcelHelper.getColumnsWidth(i, n);
                        t.find("thead tr td[haswidth]").map(function (t, e) {
                            var n = $(e).attr("id"), i = o[n];
                            $(e).css("width", i + "pt");
                        });
        ...
        function (t, e, n) {
            ...
            var i = function () {
                ...
                return t.prototype.createTarget = function () {
                    return this.target = $(' <div class="hiprint-option-item" style="display: none">\n        <div class="hiprint-option-item-label">\n        标题显示隐藏\n        </div>\n        <div class="hiprint-option-item-field">\n        <select class="auto-submit">\n        <option value="" >默认</option>\n            <option value="false" >显示</option>\n            <option value="true" >隐藏</option>\n        </select>\n        </div>\n    </div>'), this.target;
                }, t.prototype.getValue = function () {
                ...
                return t.prototype.css = function (t, e) {
                    ...
                    this.target.find("input").minicolors({
                        defaultValue: t || "", theme: "bootstrap"
                ...
                return t.prototype.createTarget = function () {
                    ...
                    this.allColumns = t[0].columns.concat(r), t && 1 == t.length && (this.target.find("ul").html(this.allColumns.map(function (t, e) {
                        ...
                        revert: !0, handle: ".column-title", moveUnit: "pt", deltaX: 0, deltaY: 0
                    }).hidroppable({
                    ...
                    return this.allColumns.filter(function (t) {
                        ...
                        var o = $(i).attr("column-id"), r = t.options.makeColumnObj();
        ...
        function (t, e, n) {
            ...
            var _i, o = n(5), r = n(13), a = (_i = function i(t, e) {
        ...
        function (t, e, n) {
            ...
            var i = n(10), o = function () {
                function t() {
                }
        
                return t.mergeRect = function (t, e) {
                    var n = Math.min(t.x, e.x), o = Math.min(t.y, e.y);
                    return new i.b({
                        x: n,
                        y: o,
                    ...
                    return {
                        minX: t < n ? t : n, minY: e < i ? e : i, maxX: t < n ? n : t, maxY: e < i ? i : e
                    };
                }, t;
            }();
        }, 
                ...
                __extends = (_extendStatics = function extendStatics(t, e) {
                    ...
                    return __extends(TablePrintElement, _super), TablePrintElement.prototype.getColumns = function () {
                        ...
                        return this.designTarget = this.getHtml(t)[0].target, this.designPaper = t, this.designTarget.find("td").hidroppable({
                            accept: ".rn-draggable-item", onDrop: function onDrop(t, e) {
                        ...
                        var n = [], i = this.getData(e), o = this.getTableHtml(i, e),
                        ...
                        var a = i.find("tbody"), p = _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.pt.toPx(e);
        
                        n.find(".hiprint-printElement-tableTarget tbody").html("");
                        var s = n.outerHeight();
                        if (s > p) return {
                            target: void 0, length: 0, height: 0, isEnd: !1
                        };
                        ...
                        for (var l = [], u = 0; u < this.options.getGridColumns(); u++) {
                            for (var d = n.find(".hiprint-printElement-tableTarget:eq(" + u + ")"), c = void 0, h = []; ;) {
                                if (s <= p) if (0 == a.find("tr").length) c = {
                                    height: _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.px.toPt(s), isEnd: !0
                                    ...
                                    l.push(g), h.push(g), (s = n.outerHeight()) > p && (a.prepend(f), l.pop(), h.pop(), s = n.outerHeight(), c = {
                                        height: _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.px.toPt(s), isEnd: !1
                                    });
                                }
                        ...
                        this.designTarget.hidraggable({
                            ...
                            showPoints: n.getReizeableShowPoints(), noContainer: !0, onBeforeResize: function onBeforeResize() {
                        ...
                        this.designTarget.find(".hiprint-printElement-tableTarget:eq(0)").find("thead td").bind("click.hiprint", function (e) {
                            ...
                            if (i) {
                                ...
                                _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.event.trigger(t.getPrintElementSelectEventKey(), {
                                    printElement: t, customOptionsInput: [{
                                        title: i.title + "-列属性", optionItems: o, options: i, callback: function callback(t) {
        ...
        function (t, e, n) {
            ...
            var i = function () {
                ...
                return t.getColumnsWidth = function (e, n) {
                    var i = {}, o = t.allAutoWidth(e);
                    return e.rowColumns.forEach(function (t) {
                        var e = n - 0, r = t.width / o * (e > 0 ? e : 0);
                        i[t.id] = r;
                    }), i;
                ...
                return t.prototype.init = function () {
                    ...
                    var t = this, e = this, n = [], i = $('<div class="columngrips"/>');
                        ...
                        o.columns.forEach(function (o, a) {
                            if (o.getTarget().attr("haswidth")) {
                                ...
                                n.length > 0 && (n[n.length - 1].nextGrip = s), n.push(s), t.syncGrips(o, s), $(p).hidraggable({
                                    axis: "h", onDrag: function onDrag(t, e, n) {
                                    }, moveUnit: "pt", minMove: 1, onBeforeDrag: function onBeforeDrag(t) {
                    ...
                    var t = this, e = this, n = [], i = $('<div class="rowgrips"/>');
                    this.rows.forEach(function (o, a) {
                        ...
                        n.push(s), a > 0 && a < t.rows.length && $(p).hidraggable({
                            axis: "v", onDrag: function onDrag(t, e, n) {
                            }, moveUnit: "pt", minMove: 1, onBeforeDrag: function onBeforeDrag(t) {
                    ...
                    e.cell = t, e.target.css({
                        left: n.offset().left - this.target.offset().left + n.outerWidth(!1), height: 30
                    });
                    ...
                    this.rgripContariner.target.height(this.target.height()), this.rows.forEach(function (e, n) {
                        ...
                        t.rgripContariner.grips[n].target.css({
                            top: i.offset().top - t.target.offset().top + i.outerHeight(!1), width: 30
                        });
                    });
            ...
            var y = function () {
                ...
                return t.prototype.insertRow = function (t, e, n) {
                    var i = e || this.tableCellSelector.getSingleSelect(), o = i.cell, a = this.rows[i.rowIndex],
                        p = i.rowIndex, s = this.getCellGrid(), u = new l.a();
                    if (u.init(this.optionsCoat, void 0, a.isHead), n && u.getTarget().addClass(n), "above" == t) s[p].forEach(function (t) {
                        var e = t.link ? t.link : t.cell, n = e.width / e.colspan;
                    ...
                    var o = this, a = this.rows.concat(this.trRows), p = e || this.tableCellSelector.getSingleSelect(),
                        s = p.cell, l = p.rowIndex, u = this.getCellGrid(a), d = u[l].filter(function (t) {
                    ...
                    if ("left" == t) {
                        ...
                        u.forEach(function (t, e) {
                            var p = t[c], s = t.filter(function (t, e) {
                                return e >= c && t.cell;
                            });
        
                            if (0 == p.rowLevel) {
                                var l = a[e], u = a[e].createTableCell();
                        ...
                        u.forEach(function (t, e) {
                            var p = t[h], s = t.filter(function (t, e) {
                                return e <= h && t.cell;
                            });
        
                            if (p.rightMost) {
                                var l = a[e], u = l.createTableCell();
                    ...
                    var t = this, e = this.tableCellSelector.getSingleSelect(), n = (e.cell, this.rows[e.rowIndex], e.rowIndex),
                        i = this.getCellGrid(), o = this.rows[n];
                        ...
                        if (e.cell) {
                            if (1 == e.cell.rowspan) o.removeCell(e.cell); else {
                                ...
                                var a = i[n + 1].filter(function (t, e) {
                                    return t.cell && e > r;
                                }), p = t.rows[n + 1], s = p.createTableCell(e.cell.rowspan - 1, e.cell.colspan);
                    ...
                    var t = this.rows.concat(this.trRows), e = this.tableCellSelector.getSingleSelect(), n = e.cell,
                        i = e.rowIndex, o = this.getCellGrid(t), r = o[i].filter(function (t) {
                    ...
                    var t = this, e = this.tableCellSelector.getSelectedCells();
                    ...
                    var t = this.tableCellSelector.getSingleSelect(), e = this.getCellGrid(),
                    ...
                    var e = t || this.rows, n = this.getColumnStep(), i = new Array();
                    ...
                    $(this.handle).hicontextMenu({
                        menus: [{
                            ...
                            text: "删除行", enabled: this.optionsCoat.options.isEnableDeleteRow, disable: function disable() {
                                return !t.tableCellSelector.getSingleSelect();
                            }, callback: function callback() {
                            ...
                            text: "对齐", borderBottom: !0, enabled: this.optionsCoat.options.columnAlignEditable, menus: [{
                                text: "左", callback: function callback() {
                                    t.setAlign("left");
                                }
                            }, {
                                text: "左右居中", callback: function callback() {
                                    t.setAlign("center");
                                }
                            }, {
                                text: "右", callback: function callback() {
                                    t.setAlign("right");
                                }
                            }, {
                                text: "默认", borderBottom: !0, callback: function callback() {
                                    t.setAlign("");
                                }
                            }, {
                                text: "上", callback: function callback() {
                                    t.setVAlign("top");
                                }
                            }, {
                                text: "垂直居中", callback: function callback() {
                                    t.setVAlign("middle");
                                }
                            }, {
                                text: "下", callback: function callback() {
                                    t.setVAlign("bottom");
                                }
                            }, {
                                text: "默认", callback: function callback() {
                                    t.setVAlign("");
                                }
                            }]
                        }, {
            ...
            var _p, s = (_p = function p(t, e) {
                ...
                function e(e, n) {
                    ...
                    (e = e || {}, (i = t.call(this, e) || this).lHeight = e.lHeight, i.autoCompletion = e.autoCompletion, i.tableFooterRepeat = e.tableFooterRepeat, n) && (i.columns = [], n.editable && e.columns && e.columns.length ? e.columns.forEach(function (t) {
                        var e = [];
                        t.forEach(function (t) {
                            var i = new r(t), o = n.getColumnByColumnId(i.columnId), p = o ? $.extend(o, i) : new a.a(i);
                            p.checked = !0, e.push(p);
        ...
        function (t, e) {
            !function (t) {
                function e(e) {
                    var n = t.data(e.data.target, "hidraggable"), i = n.options, o = n.proxy, r = e.data,
                        a = r.startLeft + e.pageX - r.startX, p = r.startTop + e.pageY - r.startY;
                ...
                function n(e) {
                    var n = t.data(e.data.target, "hidraggable"), i = n.options, o = n.proxy;
                    o || (o = t(e.data.target)), o.css({
                        left: t.fn.dragLengthC(e.data.left, i), top: t.fn.dragLengthC(e.data.top, i)
                    }), t("body").css("cursor", i.cursor);
                }
        
                function i(i) {
                    t.fn.hidraggable.isDragging = !0;
                    var o = t.data(i.data.target, "hidraggable"), r = o.options, a = t(".hidroppable").filter(function () {
                ...
                function r(e) {
                    ...
                    var n, i, r = t.data(e.data.target, "hidraggable"), a = r.proxy, p = r.options;
                    p.revert ? 1 == l() ? t(e.data.target).css({
                        ...
                        position: "absolute", left: t.fn.dragLengthC(e.data.left, p), top: t.fn.dragLengthC(e.data.top, p)
                    }), l());
                ...
                t.fn.hidraggable = function (e, n) {
                    return "string" == typeof e ? t.fn.hidraggable.methods[e](this, n) : this.each(function () {
                        var n, a = t.data(this, "hidraggable");
                        ...
                        function s(e) {
                            var n = t.data(e.data.target, "hidraggable"), i = n.handle, o = t(i).offset(),
                                r = t(i).outerWidth(), a = t(i).outerHeight(), p = e.pageY - o.top, s = o.left + r - e.pageX,
                                l = o.top + a - e.pageY, u = e.pageX - o.left;
                        ...
                        t.data(this, "hidraggable", {
                            ...
                            if (0 != s(e)) {
                                t(this).css("cursor", "");
                                var n = t(e.data.target).position(), a = t(e.data.target).offset(), p = {
            ...
            !function (t) {
                t.fn.hidroppable = function (e, n) {
                    return "string" == typeof e ? t.fn.hidroppable.methods[e](this, n) : (e = e || {}, this.each(function () {
                        var n, i = t.data(this, "hidroppable");
                    ...
                    accept: null, disabled: !1, onDragEnter: function onDragEnter(t, e) {
                    }, onDragOver: function onDragOver(t, e) {
                    }, onDragLeave: function onDragLeave(t, e) {
                    }, onDrop: function onDrop(t, e) {
                    }
        ...
        function (t, e) {
            ...
            (n = jQuery).hiprintparser = {
                parseOptions: function parseOptions(t, e) {
                    var i = n(t), o = {}, r = n.trim(i.attr("data-options"));
            ...
            n = jQuery, i = {
                ...
                numHandlerText: function numHandlerText(t) {
                    ...
                    for (var e = 0; e < t.length; e++) {
                        t[e].css({
                            position: "absolute", width: "8px", height: "8px", background: "#ff6600", "border-radius": "50%"
                        });
                    }
                    ...
                    var i = this, o = 0, r = 0, a = t.width(), p = t.height(), s = t.offset().left, l = t.offset().top,
                        u = i.options.noContainer ? n(e) : t.parent(), d = !1;
                    ...
                    t.on("mousedown", function (t) {
                        ...
                        if (d) {
                            ...
                            height: i.numHandlerText(p - E), top: i.numHandlerText(i.options.noDrag ? void 0 : l + E)
                            ...
                            width: i.numHandlerText(a + n), height: i.numHandlerText(p + E)
...
function (t, e, n) {
            ...
            function h(t, e) {
                for (var n = [], i = {}, o = 0; o < t.length; o++) {
                    var r = t[o], a = e.base ? r[0] + e.base : r[0], p = {
            ...
            window, document, n = jQuery, (i = function i(t, e) {
                ...
                init: function init(t, e) {
                    this.ele = t, this.defaults = {
                        menu: [{
                            text: "text", menus: [{}, {}], callback: function callback() {
                            }
...
function (t, e, n) {
            ...
            var _r, a = function () {
            ...
            }(), f = n(4), g = n(3), m = (_r = function r(t, e) {
                ...
                return t.prototype.subscribePaperBaseInfoChanged = function (t) {
                    ...
                    var e = this, n = this.target.find(".hiprint-paperNumber");
                    ...
                    this.createHeaderLine(), this.createFooterLine(), this.target.addClass("design"), this.paperNumberTarget = this.createPaperNumber(this.formatPaperNumber(1, 1)), this.createRuler(), this.resetPaperNumber(this.paperNumberTarget), $(this.paperNumberTarget).bind("dblclick.hiprint", function () {
                        ...
                        o.a.event.trigger("BuildCustomOptionSettingEventKey_" + e.templateId, {
                            options: {
                                paperNumberFormat: e.paperNumberFormat, paperNumberDisabled: e.paperNumberDisabled
                    ...
                    var i = this;
                    t.hidraggable({
                        axis: n ? void 0 : "v", onDrag: function onDrag(t, n, i) {
                            e(n, i);
                        }, moveUnit: "pt", minMove: p.a.instance.movingDistance, onBeforeDrag: function onBeforeDrag(t) {
                ...
                return _(e, t), e.prototype.getDesignTarget = function (e) {
                    ...
                    t && this.SetProxyTargetOption(t);
                    var e = this.getData(), n = this.createTarget(this.printElementType.getText(!0), e);
                    return this.updateTargetSize(n), this.css(n, e), n;
                }, e.prototype.updateDesignViewFromOptions = function () {
                    if (this.designTarget) {
                        var t = this.getData(), e = this.getHtml(this.designPaper)[0].target;
                    ...
                    var i = t.find(".hiprint-printElement-longText-content"), o = this.getText(e, n);
                    i.html(o);
                }, e.prototype.createTarget = function (t, e) {
                    ...
                    var i = this, o = [], r = 0, a = n || this.getData(e), p = this.getText(this.getTitle(), a),
                    ...
                    if (u.forEach(function (t, e) {
                        ...
                        target: f.target, printLine: this.options.displayTop() + f.height, referenceElement: new E.a({
                            top: this.options.getTop(),
                            left: this.options.getLeft(),
                            height: this.options.getHeight(),
                            width: this.options.getWidth(),
                    ...
                    for (var d = this.getBeginPrintTopInPaperByReferenceElement(t); l.length > 0;) {
                        ...
                        f.target.css("left", this.options.displayLeft()), f.target[0].height = "", 0 == r || c > 0 ? (m = d, f.target.css("top", m + "pt"), g = l.length > 0 ? d + f.height : null != this.options.lHeight ? d + (f.height > this.options.lHeight ? f.height : this.options.lHeight) : d + f.height) : (m = t.paperHeader, f.target.css("top", m + "pt"), g = m + f.height), o.push(new P.a({
                            target: f.target, printLine: g, referenceElement: new E.a({
                                top: this.options.getTop(),
                                left: this.options.getLeft(),
                                height: this.options.getHeight(),
                                width: this.options.getWidth(),
                    ...
                    var i = o.a.pt.toPx(e), r = this.IsPaginationIndex(t, t.length - 1, i, n);
                    ...
                    return e >= t.length - 1 && a < n ? {
                        IsPagination: !0, height: o.a.px.toPt(a), length: t.length, target: i.clone()
                    } : a <= n && r >= n ? {
                        IsPagination: !0, height: a, length: e + 1, target: i.clone()
                    } : a >= n ? {
                ...
                return Y(e, t), e.prototype.updateDesignViewFromOptions = function () {
                    ...
                    for (var a, p = this.getBeginPrintTopInPaperByReferenceElement(t), s = 0, l = !1; !l;) {
                        ...
                        h.target && (h.target.css("left", this.options.displayLeft()), h.target[0].height = ""), 0 == s || u > 0 ? (h.target && (a = p, h.target.css("top", p + "pt")), f = l && null != this.options.lHeight ? p + (h.height > this.options.lHeight ? h.height : this.options.lHeight) : p + h.height) : (h.target && (a = t.paperHeader, h.target.css("top", t.paperHeader + "pt")), f = t.paperHeader + h.height), n.push(new P.a({
                            target: h.target, printLine: f, referenceElement: new E.a({
                                top: this.options.getTop(),
                                left: this.options.getLeft(),
                                height: this.options.getHeight(),
                                width: this.options.getWidth(),
                    ...
                    var p = void 0, s = n.find("tbody"), l = o.a.pt.toPx(t);
                    e.find("tbody").html("");
                        ...
                        if (u <= l) {
                            if (0 == s.find("tr").length) {
                                a && this.options.autoCompletion && (this.autoCompletion(l, e), u = e.outerHeight()), p = {
                                    target: e.clone(), length: e.find("tbody tr").length, height: o.a.px.toPt(u), isEnd: !0
                                ...
                                d.push(h), u > l && (s.prepend(c), d.pop(), u = e.outerHeight(), p = {
                                    target: e.clone(), length: e.find("tbody tr").length, height: o.a.px.toPt(u), isEnd: !1
                                });
                            }
                        } else p = {
                            target: void 0, length: 0, height: 0, isEnd: !1
                ...
                return t.getElementTypeGroups = function (e) {
                    ...
                    var i = t.formatterModule(n), o = new l().createPrintElementTypeHtml(e, this.getElementTypeGroups(i));
                    this.enableDrag(o);
                }, t.buildByHtml = function (t) {
                    this.enableDrag(t);
                }, t.enableDrag = function (e) {
                    e.hidraggable({
                        revert: !0, proxy: function proxy(t) {
                        ...
                        }, moveUnit: "pt", minMove: 4, onBeforeDrag: function onBeforeDrag(e) {
                            s.a.instance.draging = !0;
                ...
                return t.prototype.updateRect = function (t, e) {
                    ...
                    null != t && (this.lastLeft = this.lastLeft + t), null != e && (this.lastTop = this.lastTop + e), this.target.css({
                        left: this.lastLeft + "pt", top: this.lastTop + "pt"
                    });
                }, t;
            }(), pt = function () {
                function t(t, e) {
                ...
                return t.prototype.design = function (t) {
                    ...
                    t.getTarget().hidroppable({
                        accept: ".ep-draggable-item", onDrop: function onDrop(n, i) {
                            var r = s.a.instance.getDragingPrintElement(), a = r.printElement;
                    ...
                    var e = this, n = this.designPaper.getTarget();
                ...
                return t.prototype.init = function () {
                    ...
                    var e = this, n = this, i = t.printElement, o = t.customOptionsInput;
                    ...
                    var a = $('<br/><button class="hiprint-option-item-settingBtn hiprint-option-item-submitBtn"\n        type="button">确定</button>');
                ...
                return t.prototype.buildPagination = function (t) {
                    var e = this.template.getPaneltotal(), n = this;
                    this.jqPaginationContainer.html("");
        
                    for (var i = $('<ul class="hiprint-pagination"></ul>'), o = function o() {
                        var t = r, e = $("<li><span>" + (t + 1) + '</span><a href="javascript:void(0);">x</a></li>');
                ...
                return t.prototype.design = function (t, e) {
                    ...
                    var i = $('<div class="hiprint-printTemplate"></div>'), o = [];
                    ...
                    return new pt(new rt({
                        index: this.printPanels.length, paperType: "A4"
                    }), this.id);
                    ...
                    if (t || (t = {}), e || (e = {}), this.clientIsOpened()) {
                        var n = this, i = 0, o = {}, r = $("link[media=print]").length > 0 ? $("link[media=print]") : $("link");
                        r.each(function (a, p) {
                    ...
                    if (-1 == e.indexOf("base64")) try {
                        if (!this.tempimageBase64[e]) {
                            var n = document.createElement("canvas"), i = new Image();
                        ...
                        r.each(function (a, p) {
                            ...
                            l.open("GET", $(p).attr("href")), l.onreadystatechange = function () {
                                if (4 === l.readyState && 200 === l.status && (o[a + ""] = '<style rel="stylesheet" type="text/css">' + l.responseText + "</style>", ++i == r.length)) {
                                    ...
                                    var d = p + $(t)[0].outerHTML, c = $.extend({}, e || {});
                    ...
                    if (this.printPanels.length) {
                        var r = o.a.mm.toPt(this.printPanels[0].width), a = o.a.mm.toPt(this.printPanels[0].height),
                            p = $.extend({
                                scale: 2, width: o.a.pt.toPx(r), x: 0, y: 0, useCORS: !0
                            }, n || {}), s = new jsPDF({
                    ...
                    t.find("svg").each(function (t, e) {
                        var n = e.parentNode, i = document.createElement("canvas"),
